...
<head>
  ...
  <!-- Primary Meta Tags -->
  <title>로또인사이트 - AI 기반 로또 번호 분석 | 1,201회차 데이터 실시간 반영</title>
  <meta name="title" content="로또인사이트 - AI 기반 로또 번호 분석 | 1,201회차 데이터 실시간 반영">
    ...
    <div class="warning-container">
      <div class="warning-card">
        <div class="warning-header">
          ...
          <div>
            <h3 class="warning-title">역대 <?php echo number_format($latest['draw_no']);?>회 중 이런 패턴은 없었습니다</h3>
        ...
        <div class="warning-footer">
          ...
          <p class="warning-footer-text">
            로또인사이트 AI는 위 패턴을 <strong>100% 자동 회피</strong>하여 균형 잡힌 번호만 생성합니다.
          </p>
        </div>
      </div>
    </div>
      ...
      if (typeof Kakao !== 'undefined' && Kakao.isInitialized()) {
        ...
        Kakao.Share.sendDefault({
          ...
          content: {
            ...
            description: '로또인사이트 - 1,201회차 데이터 기반 AI 분석\n무료 1회 분석 즉시 제공!',
