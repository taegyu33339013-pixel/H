...
$menu['menu300'] = array(
	...
	*/
    ...
    array('300900', '당첨번호관리', G5_ADMIN_URL . '/lotto_draw_list.php', 'lotto_draw_list'),
    array('300910', '후기관리', G5_ADMIN_URL . '/lotto_review_list.php', 'lotto_review_list'),
    array('300920', '결제내역', G5_ADMIN_URL . '/lotto_toss_orders.php', 'lotto_toss_orders'),
    array('300990', 'DB설치/동기화', G5_ADMIN_URL . '/lotto_db_setup.php', 'lotto_db_setup'),
);
